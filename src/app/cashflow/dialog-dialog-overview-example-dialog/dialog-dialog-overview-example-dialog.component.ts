...
public dialogtable1(option){
  this.EventOption = option;
  if(this.EventOption === 0){
    this.dialogtable =this.option1;

  }
  if(this.EventOption === 1){
    this.dialogtable =this.option2;

  }
  if(this.EventOption === 3){
    this.dialogtable =this.option4;
